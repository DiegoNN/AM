...
func _debug_info():
	var velocidade_kmh = velocidade_atual * 3.6
	print("Velocidade (m/s): ", velocidade_atual, " Velocidade (km/h): ", velocidade_kmh)
	print("Rotação Y: ", rotation.y, " Rotação Z: ", rotation.z, " Rotação X: ", rotation.x)
